...
(header "dynamic.h"
  ...
  (decl-box DynamicType
    ...
    ;; (= Function (<> Dynamic Function) ((<> List DynamicType) params) (DynamicType out) (void * fptr))
  ...
  (impl-box DynamicType
    ...
    (func show ((CFile file) (DynamicType dt))
          ...
          (return (match# dt
                    ...
                    (* Error    data (fprintf file "DynamicType Error: %s" data))
                    ;; (* Function params out fptr (+ (fprintf file "<Function: ")
                    ;;                                ((<> show List DynamicType) file params)
                    ;;                                (fprintf file " out: ")
                    ;;                                ((<> show DynamicType) file out)
                    ;;                                (fprintf file " @%zx" (cast size_t fptr))))
