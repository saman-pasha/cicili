...
#include <stdlib.h>
#include "basic.h"
static void __ciciliLambda_main_103 (Employee ** emps_arr) {
  free (((void *)(*emps_arr )));
}
static void __ciciliLambda_main_105 (Employee ** emps_ptr_arr) {
...
int main (int argc, char * argv[]) {
  { /* cicili#Let102 */
    ...
    Employee * emps_arr __attribute__((__cleanup__(__ciciliLambda_main_103 ))) = ((Employee *)calloc (5, sizeof(Employee)));
    Employee * emps_ptr_arr __attribute__((__cleanup__(__ciciliLambda_main_105 ))) = ((Employee *)calloc (10, sizeof(Employee *)));
    free (emp );
    emp  = (&emp1 );
