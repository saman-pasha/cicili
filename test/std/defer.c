...
typedef struct cicili3WS3KxhN0p05KwU052J2v1Mn_xo_ {
  FILE * file ;
  char * msg ;
} cicili3WS3KxhN0p05KwU052J2v1Mn_xo_;
void __ciciliL_117 (struct cicili3WS3KxhN0p05KwU052J2v1Mn_xo_ * ciciliDefer114 ) {
...
int main () {
  { /* let104 */
    ...
    struct cicili3WS3KxhN0p05KwU052J2v1Mn_xo_ ciciliDefer114  __attribute__((__cleanup__(__ciciliL_117 ))) = { file , msg };
    (emp -> Id) = 100;
