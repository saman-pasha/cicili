...
(generic decl-List (a)
         ...
         (generic decl-List-with-type (type)
         ...
         (decl-List-with-type (<> List a))
         
         ) ; decl-List

(generic define-List (a fmt)

         (generic define-List-with-type (type)
                  ...
                  ) ; define-List-with-type

         (define-List-with-type (<> List a))

         ) ; define-List

(generic import-List (ctor a)

         (generic import-List-with-type (type)
                  ...
                  ) ; import-List-with-type

         (import-List-with-type (<> List a))
