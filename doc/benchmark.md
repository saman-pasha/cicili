...
The Cicili code is [here](../benchmark/word-count-bench.cicili).
The Haskell code is [here](../benchmark/word_count.hs).
...
The generated C ocde is [here](../benchmark/word_count_bench.c).
